...
data = {
    ...
    "Metabolic Health (Liver, Kidney, Sugar)": [
        ("Glucose", "84", "84", "70", "mg/dl", "70 - 99"),
        ("HbA1c", "5.18", "5.3", "—", "%", "4.8 - 5.9"),
        ("Insulin", "11.2", "8.9", "—", "µU/mL", "2.6 - 24.9"),
        ("ALT", "12", "14", "—", "U/L", "< 41"), # From PDF: 12 U/L
        ("AST", "—", "25", "—", "U/L", "< 40"),
    ...
    "Cardiac Health & Coagulation": [
        ...
        ("Cholesterol HDL", "43", "43", "—", "mg/dL", "> 40"),
    ...
    "Micronutrients (Vitamins & Minerals)": [
        ...
        ("Iron", "41", "98", "—", "µg/dl", "59 - 150"), # Range in PDF 33-193, sticking to script for now or updating? Updating to match PDF 33-193? Left as is per instruction or safer to match existing? PDF says 33-193.
        ("Folic Acid", "—", "17.0", "—", "ng/ml", "3.9 - 26.8"),
        ("Magnesium", "1.90", "2.13", "—", "mg/dl", "1.60 - 2.60"), # PDF says 1.90
    ...
    "Hormonal Panel": [
        ...
        ("Free T4 (FT4)", "16.30", "16.30", "17.70", "pmol/L", "11.90 - 21.60"),
        ("LH", "10.20", "4.46", "—", "mIU/mL", "1.70 - 8.60"),
        ("FSH", "3.0", "1.6", "3.0", "mIU/mL", "1.5 - 12.4"),
        ("SHBG", "43.2", "43.2", "34.3", "nmol/L", "18.3 - 54.1"),
        ("DHEA-SO4", "97.7", "97.7", "111.0", "µg/dl", "88.9 - 427"),
