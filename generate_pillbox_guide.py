...
PAGES = [
    ...
    },
    {
        ...
        "cells": [
            ...
            item("E.2", "Oral Minoxidil", "5 mg", icons="💇‍♂️ 🧔 ⚕️", kind="rx"),
            item("E.3", "L. reuteri Strain Blend", "200 mln CFU", icons="🦠 🚽", note="DSM 17938 + ATCC PTA 6475"),
            item("E.4", "Sodium Butyrate", "500 mg", icons="🦠 🚽", note="Butyric acid 400 mg"),
            item("E.5", "Melatonin", "1 mg", icons="😴 😌", note="Passionflower • lemon balm • hops • saffron • B6"),
    ...
    },
    {
        ...
        "cells": [
            ...
            item("B.4", "Maca Root Extract", "500 mg", icons="🍆 ⚡"),
